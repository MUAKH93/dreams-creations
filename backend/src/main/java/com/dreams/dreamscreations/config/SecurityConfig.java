    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST, "/api/shop/orders/checkout").hasRole("CUSTOMER")
                .requestMatchers(HttpMethod.GET, "/api/shop/orders/my", "/api/shop/orders/my/**").hasRole("CUSTOMER")
                .requestMatchers(HttpMethod.POST, "/api/shop/orders/my/*/cancel").hasRole("CUSTOMER")
                ...
                .requestMatchers("/api/admin/manager-accounts", "/api/admin/manager-accounts/**")
                    .hasRole("ADMIN")
                .requestMatchers("/api/admin/production-settings", "/api/admin/production-settings/**")
                    .hasRole("ADMIN")
                .requestMatchers(HttpMethod.POST, "/api/admin/staff/*/reset-password")
                    .hasRole("ADMIN")
                ...
                .requestMatchers("/api/shop", "/api/shop/**").hasAnyRole("ADMIN","MANAGER")
